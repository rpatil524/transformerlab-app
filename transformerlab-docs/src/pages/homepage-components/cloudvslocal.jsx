  ...
  return (
    <>
      ...
      <div className="col col--6">
        ...
        <h2 style={{ paddingTop: '1rem' }}>
          Are you a{' '}
          <span style={{ color: 'var(--ifm-color-primary)' }}>on a team</span>{' '}
          where you work together to train and build models on a cluster?
        </h2>
        <p>
          Run workloads on multiple nodes with multi-cloud job scheduling,
          experiment management, and monitoring. Works with Slurm, Skypilot, or
          Kubernetes.
        </p>
        <span style={{ textDecoration: 'none', marginTop: '2rem' }}>
          <a href="/beta.html" className="button button--primary button--lg">
            Join the Beta
          </a>
        </span>
      </div>
