...
**Transformer Lab** is an open-source research platform that sits _on top_ of your existing compute infrastructure. It provides a modern interface, experiment tracking, and interactive development environments while letting your underlying schedulers and clouds do what they do best.
