...
- _Note:_ If want to start playing with Slurm try out [slurm-docker-cluster](https://github.com/giovtorres/slurm-docker-cluster) which will create a containerized slurm installation with several containerized nodes which is great for testing.
