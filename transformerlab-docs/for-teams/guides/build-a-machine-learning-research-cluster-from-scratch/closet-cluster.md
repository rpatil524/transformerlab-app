...
- **Warning:** _This is not recommended for critical production workloads._ The SSH backend is less robust than the Kubernetes or Cloud backends and handles node failures less gracefully. Use this primarily for temporary testing or loose clusters of diverse machines.
...
- **Guide:** _[See our separate guide on Installing Rancher for ML Clusters]_
