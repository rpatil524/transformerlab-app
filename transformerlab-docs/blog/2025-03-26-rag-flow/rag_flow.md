...
_These files contain detailed information about the three synthesizer plugins (Generate from Documents, Raw Text and Scratch) in Transformer Lab._
...
_The generated dataset will contain questions that span different aspects of the documentation._
...
_We're fine-tuning on our specific documentation domain to improve retrieval performance on Transformer Lab-related queries._
...
_By selecting the embedding model in the Foundation tab, we tell the system which embeddings to use for our RAG pipeline._
...
_The model server needs to be running for the RAG pipeline to generate embeddings for our documents._
...
_This comparison will help us understand how fine-tuning improves or degrades retrieval quality for our specific documentation domain._
...
_The evaluation results will show us how fine-tuning affects:_

- _Contextual Precision: How accurately the retrieved content matches the query context_
- _Answer Relevancy: How relevant the generated answers are to the original questions_
