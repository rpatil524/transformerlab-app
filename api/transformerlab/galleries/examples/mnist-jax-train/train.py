...
def main():
    ...
    prediction_save_every_steps = int(
        config.get("prediction_save_every_steps", prediction_save_every_steps) or prediction_save_every_steps
    )
            ...
            for images, labels in train_loader:
                ...
                if (
                    ...
                    try:
                        ...
                        saved = visualize_predictions(
                            imgs_chw, preds, output_dir, stage=f"epoch{epoch}_step{global_step}"
                        )
                        if saved:
