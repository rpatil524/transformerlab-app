    ...
    for i, prompt in enumerate(prompts):
        ...
        try:
            ...
            if proc.returncode != 0:
                ...
                results.append(
                    {"prompt": prompt, "output": None, "status": "error", "rc": proc.returncode, "duration_s": duration}
                )
            else:
            ...
            results.append(
                {"prompt": prompt, "output": None, "status": "exception", "error": str(e), "duration_s": duration}
            )
